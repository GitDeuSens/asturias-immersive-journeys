...
const NotFound = () => {
  ...
  const content = {
    es: {
      ...
      description:
        "La página que buscas no existe o ha sido movida. Pero no te preocupes, hay mucho más por explorar en Asturias.",
    ...
    en: {
      ...
      description:
        "The page you're looking for doesn't exist or has been moved. But don't worry, there's much more to explore in Asturias.",
      home: "Back to home",
    ...
    fr: {
      ...
      description:
        "La page que vous recherchez n'existe pas ou a été déplacée. Mais ne vous inquiétez pas, il y a beaucoup plus à explorer dans les Asturies.",
      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-primary font-medium mb-2">{c.subtitle}</p>
            <p className="text-muted-foreground mb-8 max-w-md mx-auto">{c.description}</p>
          </motion.div>
          ...
          >
            <Button variant="outline" onClick={() => window.history.back()} className="gap-2" aria-label={c.back}>
