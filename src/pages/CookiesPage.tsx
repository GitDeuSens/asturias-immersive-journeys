...
const cookiesContent = {
  es: {
    ...
    intro: 'Este sitio web utiliza cookies propias y de terceros para mejorar su experiencia de navegación, analizar el tráfico del sitio y personalizar el contenido.',
    what: {
    ...
    types: {
      ...
      list: [
        ...
        },
        {
          ...
          description: 'Nos ayudan a entender cómo los visitantes interactúan con el sitio. Usamos Google Analytics con IP anonimizada.',
          duration: '2 años'
        },
        {
  ...
  en: {
    ...
    intro: 'This website uses its own and third-party cookies to improve your browsing experience, analyze site traffic, and personalize content.',
    what: {
    ...
    types: {
      ...
      list: [
        ...
        },
        {
          ...
          description: 'Help us understand how visitors interact with the site. We use Google Analytics with anonymized IP.',
          duration: '2 years'
        },
        {
  ...
  fr: {
    ...
    intro: 'Ce site web utilise des cookies propres et tiers pour améliorer votre expérience de navigation, analyser le trafic du site et personnaliser le contenu.',
    what: {
    ...
    types: {
      ...
      list: [
        ...
        },
        {
          ...
          description: 'Nous aident à comprendre comment les visiteurs interagissent avec le site. Nous utilisons Google Analytics avec IP anonymisée.',
          duration: '2 ans'
        },
        {
          name: 'Cookies de préférences',
          description: 'Enregistrent vos préférences comme le mode d\'exploration sélectionné (depuis chez soi / aux Asturies).',
          duration: '1 an'
        }
      ]
    },
