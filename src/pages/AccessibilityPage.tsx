...
import { Eye, Keyboard, Volume2, MousePointer2, Monitor, Languages, Contrast, ZoomIn } from "lucide-react";
...
const accessibilityContent = {
  es: {
    ...
    intro:
      "El Principado de Asturias se compromete a hacer accesible su sitio web de conformidad con el Real Decreto 1112/2018, de 7 de septiembre, sobre accesibilidad de los sitios web y aplicaciones para dispositivos móviles del sector público.",
    conformance: {
  ...
  en: {
    ...
    intro:
      "The Principality of Asturias is committed to making its website accessible in accordance with Royal Decree 1112/2018, of September 7, on accessibility of websites and mobile applications in the public sector.",
    conformance: {
  ...
  fr: {
    ...
    intro:
      "La Principauté des Asturies s'engage à rendre son site web accessible conformément au décret royal 1112/2018 du 7 septembre sur l'accessibilité des sites web et des applications mobiles du secteur public.",
    conformance: {
      ...
      list: [
        {
          ...
          description:
            "Tout le contenu est accessible via le clavier. Utilisez Tab pour naviguer et Entrée pour activer.",
        },
        {
          icon: "Volume2",
      ...
      <main id="main-content" className="flex-1 pt-14 md:pt-[122px]" role="main">
        <div className="container mx-auto px-4 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            {/* Last Update */}
            <p className="text-sm text-muted-foreground text-center">{content.lastUpdate}</p>
          </motion.div>
        </div>
      </main>
