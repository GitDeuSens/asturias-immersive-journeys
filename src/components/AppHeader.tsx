      ...
      <div style={{backgroundColor: '#006db0', color: 'white'}} >
        <div className="container mx-auto px-3 sm:px-4 py-1.5 md:py-3 flex items-center justify-between">
          ...
          <Link to="/experience" className="flex items-center gap-4 group" aria-label="Asturias Inmersivo - Inicio">
            <div style={{ display: 'flex', flexDirection: 'row', height: '36px' }} className="md:h-[58px]">
              <svg fill="white" width={32} className="md:w-[50px]">
              ...
              <span style={{paddingTop: '12px'}} className="hidden sm:block text-sm max-w-[180px] leading-tight md:pt-[20px]">
                {t("common.title")}
              </span>
            </div>
          </Link>
