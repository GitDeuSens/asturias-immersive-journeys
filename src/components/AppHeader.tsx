      ...
      >
        ...
        <div className="bg-accent text-accent-foreground">
          <div className="container mx-auto px-3 sm:px-4 py-2 md:py-3 flex items-center justify-between gap-2">
            ...
            {/* Desktop nav links — hidden on /experience */}
            {!isExperiencePage && (
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <button
                ...
                className="flex items-center justify-center w-10 h-10 rounded-lg bg-white/10 hover:bg-white/20 transition-colors text-white"
