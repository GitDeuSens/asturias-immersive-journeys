      ...
      <div style={{backgroundColor: '#006db0', color: 'white'}} >
        <div className="container mx-auto px-3 sm:px-4 py-1.5 md:py-3 flex items-center justify-between">
          ...
          <Link to="/experience" className="flex items-center gap-4 group" aria-label="Asturias Inmersivo - Inicio">
            <div className="flex flex-row items-center gap-2 h-[36px] md:h-[50px]">
              <svg fill="white" viewBox="0 0 33 60" className="w-[20px] h-[36px] md:w-[28px] md:h-[50px] shrink-0">
              ...
              <span className="hidden sm:block text-xs md:text-sm max-w-[160px] md:max-w-[180px] leading-tight">
                {t("common.title")}
              </span>
            </div>
          </Link>
