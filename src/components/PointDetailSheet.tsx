  ...
  return (
    <>
      <AnimatePresence>
        ...
        >
          <div className="relative h-56 bg-cover bg-center flex-shrink-0"
            style={{ backgroundImage: (arScene?.preview_image || (point.coverImage ? `http://192.168.12.71:8055/assets/${point.coverImage}` : '')) ? `url(${arScene?.preview_image || `http://192.168.12.71:8055/assets/${point.coverImage}`})` : undefined }}>
