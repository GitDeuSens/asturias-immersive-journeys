import type { Collider, ColliderDesc, QueryFilterFlags, World } from '@dimforge/rapier3d-compat';
...
export declare class RapierPhysics implements IPhysicsEngine {
     ...
     */
    createCollider(collider: ICollider, desc: ColliderDesc): Collider | null;
    /**
